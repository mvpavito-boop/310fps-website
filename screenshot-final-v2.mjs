...
(async () => {
  ...
  await desktop.goto('http://localhost:3004/about', { waitUntil: 'domcontentloaded' });
  ...
  await mobile.goto('http://localhost:3004/about', { waitUntil: 'domcontentloaded' });
  ...
  await deskSection.goto('http://localhost:3004/about', { waitUntil: 'domcontentloaded' });
  ...
  await mobSection.goto('http://localhost:3004/about', { waitUntil: 'domcontentloaded' });
